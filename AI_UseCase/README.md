...
📸 **Screenshot to add**: PDF upload + RAG response
...
📸 **Screenshot to add**: Booking flow with confirmation screen
...
📸 **Screenshot to add**: Email confirmation message
...
📸 **Screenshot to add**: Booking retrieval result
...
📸 **Screenshot to add**: Admin dashboard with table
